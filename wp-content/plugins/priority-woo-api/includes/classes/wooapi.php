    ...
    public function syncCustomer($id)
    {
        ...
        if ($user = get_userdata($id)) {
            ...
            $json_request = json_encode([
                ...
                'ECUSTDES'     => isset($meta['first_name'], $meta['last_name']) ? $meta['first_name'][0] . ' ' . $meta['last_name'][0] : '',
        ...
        foreach ($order->get_items() as $item) {
            ...
            if ($product) {
                ...
                $data['ORDERITEMS_SUBFORM'][] = [
                    ...
                    "CUTT_RINGSIZE"    => isset($parameters['ring_size']) ? $parameters['ring_size'] : '',
                    "CUTT_CHAINLEN"    => isset($parameters['CUTT_CHAINLEN']) ? $parameters['CUTT_CHAINLEN'] : '',
                    "CUTT_CLAPSTYPE"   => isset($parameters['CUTT_CLAPSTYPE']) ? $parameters['CUTT_CLAPSTYPE'] : '',
                    "CUTT_SETCOLOR"    => isset($parameters['CUTT_SETCOLOR']) ? $parameters['CUTT_SETCOLOR'] : '',
